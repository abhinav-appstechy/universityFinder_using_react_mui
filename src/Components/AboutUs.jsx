...
import userAvatar from "../assets/team_member.avif"
      ...
      <div className="sm:max-w-5xl max-w-sm mx-auto">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-16 text-center mt-24">
          {Array.from({length: 8}).map((item, idx)=>(
            <div className="bg-gray-200 relative rounded" key={idx}>
            <img src={userAvatar} className="w-32 h-32 rounded-full inline-block -mt-12" />
            <div className="py-4">
